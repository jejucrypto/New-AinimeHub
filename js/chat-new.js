...
function initializeChat() {
    ...
    try {
        ...
        socket.on('load_messages', (messages) => {
            ...
            messages.forEach(msg => {
                ...
                addChatMessage(msg.username, msg.message, isUser, msg.timestamp);
            });
        ...
        socket.on('message', (data) => {
            ...
            addChatMessage(data.username, data.message, isUser, data.timestamp);
        });
        ...
        socket.on('active_users', (users) => {
            ...
            // Could update a user list UI here if needed
        });
     ...
     */
    function addChatMessage(username, message, isUser = false, timestamp = null) {
...
function initializeMockChat() {
    ...
    // Mock chat data
    const mockUsers = [
        { id: 'user_1', name: 'OnePieceFan', avatar: 'https://i.pravatar.cc/150?img=1' },
        { id: 'user_2', name: 'DemonSlayer', avatar: 'https://i.pravatar.cc/150?img=2' },
        { id: 'user_3', name: 'AnimeExplorer', avatar: 'https://i.pravatar.cc/150?img=3' },
        { id: 'user_4', name: 'OtakuMaster', avatar: 'https://i.pravatar.cc/150?img=4' },
        { id: 'user_5', name: 'MangaReader', avatar: 'https://i.pravatar.cc/150?img=5' }
    ];
    ...
    function addMessageToChat(message) {
        ...
        // Get user info
        const user = isCurrentUser ? currentUser : mockUsers.find(u => u.id === message.userId) || { name: 'Unknown', avatar: '' };
